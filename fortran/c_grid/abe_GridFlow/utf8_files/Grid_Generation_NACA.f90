...
&            m, is, ie, js, je, ks, ke, i1, i2, i3, dom1, dom2, dom3, x, y, z )
 ...
 &                       z(is:ie, js:je, ks:ke)
 ! 局所定数 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 real   , parameter :: rs1 = 0.0 * 1.0e-1				! 領域@起点格子幅
 real   , parameter :: re1 = 6.0 * 1.0e-2				! 領域@終点格子幅
 real   , parameter :: rs2 = 7.0 * 1.0e-1				! 領域A起点格子幅
 real   , parameter :: re2 = 1.0 * 1.0e-1                               ! 領域A終点格子幅
 real   , parameter :: rs3 = 1.0 * 1.0e-1				! 領域B起点格子幅
 real   , parameter :: re3 = 7.0 * 1.0e-1                               ! 領域B終点格子幅
 real   , parameter :: rs4 = 6.0 * 1.0e-2				! 領域C起点格子幅
 real   , parameter :: re4 = 0.0 * 1.0e0                                ! 領域C終点格子幅
...
&            m, is, ie, js, je, ks, ke, i1, i2, i3, dom1, dom2, dom3, x, y, z )
 ...
 ! 局所定数 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 real   , parameter :: rs1 = 0.0 * 1.0e-1				! 領域@起点格子幅
 real   , parameter :: re1 = 2.0e-1 !1.0e-3 !6.0 * 1.0e-2				! 領域@終点格子幅
 real   , parameter :: rs2 = 7.0 * 1.0e-1				! 領域A起点格子幅
 real   , parameter :: re2 = 1.0 * 1.0e-1                               ! 領域A終点格子幅
 real   , parameter :: rs3 = 1.0 * 1.0e-1				! 領域B起点格子幅
 real   , parameter :: re3 = 7.0 * 1.0e-1                               ! 領域B終点格子幅
 real   , parameter :: rs4 = 2.0e-1 !1.0e-3 !6.0 * 1.0e-2				! 領域C起点格子幅
 real   , parameter :: re4 = 0.0 * 1.0e0                                ! 領域C終点格子幅
